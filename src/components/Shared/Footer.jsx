        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-8">
          <div className="lg:col-span-3 space-y-6">
            ...
            <p className="text-gray-500 leading-relaxed max-w-sm text-sm">
              Elevating events and interiors with a touch of modern luxury. We
              design moments that last a lifetime.
            </p>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              <li>
                <a className="hover:text-teal-400 transition-colors cursor-pointer">
                  About Us
                </a>
              </li>
              <li>
