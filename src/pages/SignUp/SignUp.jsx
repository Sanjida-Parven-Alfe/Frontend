  ...
  return (
    <div className="flex h-screen bg-[#0f172a] font-sans -mt-24 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1618219908412-a29a1bb7b86e?q=80&w=2000&auto=format&fit=crop')`,
        }}
      >
        ...
        <div className="relative z-10 text-center text-white p-12">
          ...
          <p className="text-xl font-light max-w-lg mx-auto leading-relaxed text-gray-200">
            Create an account to unlock exclusive design features and connect
            with top decorators.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-[500px] mt-16 lg:mt-0">
          <div className="text-center mb-4">
            <img
              src={logo}
              alt="StyleDecor"
              className="lg:hidden mx-auto h-10 w-auto mb-3 brightness-0 invert"
            />
          ...
          <div className="relative flex items-center mb-4">
            ...
            <span className="flex-shrink-0 mx-3 text-gray-500 text-xs font-medium">
              OR
            </span>
            <div className="flex-grow border-t border-gray-700"></div>
          </div>
          ...
          >
            <div className="form-control w-full">
              <label className="label pb-1">
                <span className="label-text font-semibold text-gray-300 text-xs md:text-sm">
                  Full Name
                </span>
              </label>
              <input
                ...
                className={`input input-bordered pl-2 w-full h-11 min-h-[44px] bg-white/5 border-white/10 focus:border-teal-400 text-white placeholder-gray-500 transition-all rounded-lg text-sm ${
                  errors.name ? "input-error bg-red-900/10" : ""
                }`}
            ...
            <div className="form-control w-full md:col-span-2">
              ...
              <input
                type="file"
                className={`file-input file-input-bordered w-full h-11 min-h-[44px] bg-white/5 border-white/10 text-white file:bg-teal-400 file:text-black file:border-none file:font-semibold hover:file:bg-teal-500 text-sm ${
            ...
            <div className="form-control w-full md:col-span-2">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-4 flex items-center z-50 text-gray-400 hover:text-white cursor-pointer"
                >
                  {showPassword ? (
                    <FaEyeSlash size={18} />
                  ) : (
