        ...
        <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card border-brand-teal/30">
              ...
              <span className="text-sm font-medium text-brand-teal uppercase tracking-widest">
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-tight">
              Make Your Event <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-red via-brand-yellow to-brand-teal text-glow">
                Unforgettable
              </span>
            </h1>

            <p className="text-gray-400 text-lg md:text-xl max-w-lg leading-relaxed">
              We combine luxury design with smart planning. Transform your home
              or venue into a visual masterpiece with just one click.
            </p>
      ...
      <div className="py-24 px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Crafted for <span className="text-brand-teal">Perfection</span>
          </h2>
          <p className="text-gray-400 max-w-xl mx-auto">
            Choose from our wide range of premium decoration services tailored
            for your needs.
          </p>
        </div>
            ...
            >
              <div
                className={`absolute -inset-0.5 bg-gradient-to-r from-${
                  colors[index % 3]
                } to-blue-500 rounded-2xl blur opacity-30 group-hover:opacity-100 transition duration-500`}
              ></div>
              <div className="relative glass-card rounded-2xl p-6 h-full hover:-translate-y-2 transition-transform duration-300">
                <div className="h-48 rounded-xl overflow-hidden mb-6 relative">
                  ...
                  />
                  <div className="absolute top-3 right-3 bg-black/50 backdrop-blur-md px-3 py-1 rounded-full text-xs font-bold border border-white/10">
                    {service.category}
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center border-t border-white/10 pt-4">
                  <span
                    className={`text-xl font-bold text-${colors[index % 3]}`}
                  >
                    ৳{service.cost}
                  </span>
                  <Link to={`/services/${service._id}`}>
                    <button
                      className={`w-10 h-10 rounded-full border border-white/20 flex items-center justify-center group-hover:bg-${
                        colors[index % 3]
                      } group-hover:border-${
                        colors[index % 3]
                      } transition-colors`}
      ...
      <section className="py-24 bg-brand-dark relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Meet The <span className="text-brand-red">Masters</span>
              </h2>
              <p className="text-gray-400 max-w-md">
                Our elite team of designers who turn your dreams into reality.{" "}
                <br /> Rated 5 stars by over 500+ clients.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {decorators.map((decorator) => (
              <div
                key={decorator.id}
                className={`group relative h-[420px] rounded-2xl overflow-hidden cursor-pointer border border-white/10 hover:border-${decorator.border}/50 transition-all duration-500`}
              >
                <img
                  src={decorator.image}
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 text-white z-20">
                  <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                    <p
                      className={`text-${decorator.border} text-xs font-bold tracking-widest uppercase mb-1`}
                    >
                      {decorator.specialty.split(" ")[0]}
                    </p>
                  ...
                  <div className="translate-y-20 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-between mt-4 pt-4 border-t border-white/20">
                    ...
                    <button
                      className={`w-8 h-8 rounded-full bg-white text-black flex items-center justify-center hover:bg-${decorator.border} hover:text-white transition-colors`}
                    >
                      +
                    </button>
                  </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <div className="lg:col-span-1 space-y-6">
                <h2 className="text-3xl font-bold">
                  We Cover <br />{" "}
                  <span className="text-brand-yellow">Major Cities</span>
                </h2>
                <p className="text-gray-400">
                  Check if our service is available in your area. We are
                  expanding rapidly!
                </p>
                ...
                <button className="btn bg-white text-black border-none hover:bg-gray-200 w-full rounded-lg">
                  Check Your Location
                </button>
              </div>
