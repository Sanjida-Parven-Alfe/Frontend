        ...
        <div className="bg-brand-dark min-h-screen text-white font-sans selection:bg-brand-red selection:text-white -mt-24">
            ...
            <div className="pt-32 pb-20 px-6 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-400 text-lg">Have a project in mind? We'd love to hear from you.</p>
                </div>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="glass-card p-6 rounded-xl border border-white/5 flex flex-col items-center text-center hover:border-brand-teal/50 transition-colors">
                                ...
                                <p className="text-gray-400 text-sm mt-1">hello@styledecor.com</p>
                            </div>
                        </div>
                            ...
                            <form className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="form-control">
                                        ...
                                        <input type="text" placeholder="John Doe" className="input input-bordered bg-white/5 border-gray-600 focus:border-brand-teal text-white w-full" />
                                    </div>
                                    <div className="form-control">
                                        <label className="label text-gray-400 text-sm">Email</label>
                                        <input type="email" placeholder="mail@example.com" className="input input-bordered bg-white/5 border-gray-600 focus:border-brand-teal text-white w-full" />
                                    </div>
                                </div>
                                <div className="form-control">
                                    <label className="label text-gray-400 text-sm">Subject</label>
                                    <input type="text" placeholder="Project Inquiry" className="input input-bordered bg-white/5 border-gray-600 focus:border-brand-teal text-white w-full" />
                                </div>
                                <div className="form-control">
                                    <label className="label text-gray-400 text-sm">Message</label>
                                    <textarea className="textarea textarea-bordered bg-white/5 border-gray-600 focus:border-brand-teal text-white h-32 w-full" placeholder="Tell us about your project..."></textarea>
                                </div>
                    ...
                    <div className="space-y-8">
                        {/* FAQ Section */}
                        <div>
                            <h2 className="text-2xl font-bold mb-6 text-white pl-2 border-l-4 border-brand-red">Frequently Asked Questions</h2>
                            <div className="space-y-3">
                                {[
                                    { q: "How do I book a consultation?", a: "You can book directly through our services page or call us for assistance." },
                                    { q: "Do you provide services outside Dhaka?", a: "Currently, we operate in Dhaka, Chittagong, and Sylhet. Check our coverage map for details." },
                                    { q: "What is your refund policy?", a: "You can cancel bookings up to 48 hours before the scheduled time for a full refund." },
                                    { q: "Can I customize decoration packages?", a: "Absolutely! All our packages are customizable to suit your specific needs and budget." }
                                ].map((item, idx) => (
                                    <div key={idx} className="collapse collapse-plus bg-white/5 border border-white/5 rounded-xl">
                        ...
                        <div className="glass-card p-6 rounded-2xl border border-white/10 relative overflow-hidden h-64 flex items-center justify-center group">
                            ...
                            <div className="relative z-10 text-center">
                                ...
                                <p className="text-gray-300 text-sm">Gulshan-1, Dhaka, Bangladesh</p>
                            </div>
                        </div>
                    </div>
