        ...
        >
          ...
          <div className="form-control w-full">
            ...
            <input
              ...
              className="input input-bordered pl-3 w-full bg-black/30 border-gray-600 text-white"
            />
          </div>
          ...
          <div className="form-control w-full">
            ...
            <select
              ...
              className="select select-bordered pl-3 w-full bg-black/30 border-gray-600 text-white"
            >
          ...
          <div className="form-control w-full md:col-span-2">
            ...
            <textarea
              ...
              className="textarea textarea-bordered h-24 pl-3 w-full bg-black/30 border-gray-600 text-white"
          ...
          <div className="form-control w-full md:col-span-2">
            ...
            <input
              ...
              className="file-input file-input-bordered w-full bg-black/30 border-gray-600 text-white"
            />
          </div>
