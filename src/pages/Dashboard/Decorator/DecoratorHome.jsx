...
const DecoratorHome = () => {
  ...
  const todaysTasks =
    stats.bookings?.filter((booking) => booking.date === today) || [];
    ...
    <div className="w-full p-4 md:p-8 bg-[#0f172a] min-h-full text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="stat glass-card bg-gradient-to-r from-teal-900 to-teal-600 rounded-2xl text-white border-none shadow-xl">
          ...
          <div className="stat-desc text-teal-200 mt-1">
              ...
              <tbody className="divide-y divide-white/5">
                {todaysTasks.map((task) => (
                  ...
                  >
                    ...
                    <td className="p-4 font-mono text-brand-teal">
                      {task.time}
                    </td>
                    <td className="p-4">
                      <span
                        className={`badge border-none text-black font-bold ${
