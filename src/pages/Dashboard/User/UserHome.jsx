    ...
    return (
        <div className="w-full h-full flex flex-col justify-center items-center">
            <h2 className="text-3xl font-bold text-white mb-8">
                Welcome Back, <span className="text-brand-teal">{user?.displayName}</span>!
            </h2>
            ...
            <div className="glass-card p-10 rounded-3xl border border-white/10 flex flex-col items-center text-center max-w-lg w-full shadow-2xl bg-[#1e293b]/50">
                ...
                <div className="avatar mb-6">
                    <div className="w-32 rounded-full ring ring-brand-teal ring-offset-base-100 ring-offset-2">
                        <img src={user?.photoURL || "https://i.ibb.co/MC1xh5r/user-avatar.png"} alt="profile" />
                    </div>
                </div>

                {/* Name & Email */}
                <h3 className="text-2xl font-bold text-white mb-1">{user?.displayName}</h3>
                <p className="text-brand-yellow text-sm font-semibold uppercase tracking-widest mb-6">Valued Customer</p>
