        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="md:col-span-2 space-y-8">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-4 text-white pl-2 border-l-4 border-brand-red">
                  What's Included
                </h2>
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {service.features?.map((feature, index) => (
                    <li
                      key={index}
                      className="flex items-center gap-3 glass-card p-4 rounded-xl border border-white/5 hover:border-brand-teal/30 transition-colors"
                    >
          ...
          <div className="bg-[#1e293b] w-full max-w-lg rounded-2xl border border-gray-600 shadow-2xl p-8 relative">
            ...
            <form onSubmit={handleBookingSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="form-control">
                  ...
                  <input
                    ...
                    readOnly
                    className="input input-bordered bg-black/30 text-gray-300 border-gray-600 focus:outline-none"
                  />
                </div>
                <div className="form-control">
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  className="btn w-full bg-brand-teal hover:bg-teal-400 text-black font-bold border-none rounded-full"
                >
                  Confirm Purchase
                </button>
              </div>
