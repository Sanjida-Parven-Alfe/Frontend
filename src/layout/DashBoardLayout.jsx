...
import { Link, Outlet, NavLink, useNavigate } from "react-router-dom"; // useNavigate added
import {
  FaHome,
  FaUsers,
  FaCalendarAlt,
  ...
  return (
    <div className="drawer lg:drawer-open font-sans">
      ...
      <div className="drawer-content flex flex-col bg-brand-dark text-white min-h-screen">
        <label
          htmlFor="my-drawer-2"
          className="btn btn-ghost drawer-button lg:hidden text-white pt-4 justify-start pl-6"
        >
          <svg
      ...
      <div className="drawer-side">
        ...
        <ul className="menu p-4 w-72 min-h-full bg-[#0b1120] text-gray-300 border-r border-white/10 space-y-2">
          <div className="mb-8 px-4">
            ...
            <div className="badge badge-xs badge-outline mt-2 text-gray-500">
          ...
          {isDecorator && (
            <>
              ...
              <li>
                ...
                >
                  <FaCalendarAlt /> Assigned Projects
                </NavLink>
              </li>
              <li>
                <NavLink
          ...
          <li>
            <NavLink to="/" className="hover:text-brand-teal">
              <FaHome /> Home
            </NavLink>
          </li>
          <li>
            <NavLink to="/services" className="hover:text-brand-teal">
              <MdAddBusiness /> Services
            </NavLink>
          </li>
          <li>
            <NavLink to="/contact" className="hover:text-brand-teal">
              <FaUserCog /> Contact
            </NavLink>
          </li>
          ...
          <li className="mt-auto">
            <button
              ...
              className="hover:bg-red-500/10  pl-3 hover:text-red-500 text-red-200 transition-colors duration-300"
            >
              <FaSignOutAlt /> Logout
            </button>
          </li>
